...
namespace BanDongHoAPI.Models
{
    ...
    public partial class BanDongHoEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> ThuNhapTrungBinh()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("ThuNhapTrungBinh");
        }
    }
}
