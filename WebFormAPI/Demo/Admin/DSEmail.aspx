<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="DSEmail.aspx.cs" Inherits="Demo.Admin.DSEmail" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading" style="width:123%;">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <span href="#">Danh sách email nhận tin</span>
                </li>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" runat="server">
                        ...
                        <asp:GridView runat="server"
                            ...
                            <Columns>
                                <asp:BoundField DataField="id_dang_ki_nhan_tin" HeaderText="Mã Email" />
                                <asp:BoundField DataField="email" HeaderText="Danh mục sản phẩm" />
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="btnXoa" 
                                            ...
                                            CommandArgument='<%# Eval("id_dang_ki_nhan_tin") %>'
