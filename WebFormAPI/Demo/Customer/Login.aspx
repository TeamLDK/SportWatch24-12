<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/SiteCustomer.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Demo.Customer.Login" %>
                            ...
                            <div class="l-f-o">
                                <div class="l-f-o__pad-box">
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <a class="l-f-o__create-link btn--e-transparent-brand-b-2" href="Signup.aspx">CREATE AN ACCOUNT</a></div>
                                    ...
                                    <div class="l-f-o__form">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="text" id="login-username" placeholder="Enter Username"></div>
                                        <div class="u-s-m-b-30">
                                        ...
                                        <div class="gl-inline">
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="btn btn--e-transparent-brand-b-2" value="Login" type="button" onclick="login()"/></div>
                                            <div class="u-s-m-b-30">
...
<asp:Content ID="Content3" ContentPlaceHolderID="foot" runat="server">
    <script>
        login = () => {
            ...
            let passwork = $('#login-password').val();
            callUser(username, passwork);
        }

        callUser = (username, password) => {
            let urlStr = `https://localhost:44344/api/KhachHangs?username=` + username + `&password=` + password;
            $.ajax({
                url: urlStr,
                async: false,
                success: function (response) {
                    localStorage.setItem('inforUser', response.id_kh);
