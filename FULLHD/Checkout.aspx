    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response, function (_, item) {  
                            ...
                            `
                                <div class="u-s-m-b-10">
                                    ...
                                    <div class="radio-box">
                                        ...
                                        <input type="radio" id="shipper" value="`+ item.phi_van_chuyen + `" name="payment" onclick="getCheckShipper(` + moneyShip+`);">
                                        <div class="radio-box__state radio-box__state--primary">
                        ...
                        $('#shipper').attr('id_ship', item.id_don_vi_van_chuyen);
                    })
                    $(`
                        <div>
        ...
        getCheckShipper = () => {
            ...
            for (var i = 0; i < checkbox.length; i++) {
                ...
                // vậy ví dụ ko vào if thì sao?, có phải vòng này chỉ vào if 1 lần thôi đúng ko?
                // k mỗi lần click nó sẽ gọi 1 lần // vòng for chỉ check xem thg nào đc click thôi// thì nó tìm đc 
                // thằng click rồi thì nó duyệt tiếp làm chi? thich thì breakok chưa// vứt vào đâu vứt đi
            }
        }
        ...
        addBill = () => {
            ...
            if (id_user != null) {
                $.ajax({
                    ...
                    data: {
                        "id_kh": id_user,
                        "id_don_vi_van_chuyen": getIdShip(),
                        "ghi_chu_giao_hang": $("#order-note").val(),
                    },
                    success: function (response) {
